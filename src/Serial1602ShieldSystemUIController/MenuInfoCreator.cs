...
namespace Serial1602ShieldSystemUIController
{
  public class MenuInfoCreator
  {
    ...
    public void Create (SystemMenuController controller)
    {
      ...
      irrigatorMenuStructure.Items.Add ("M", new MqttMenuItemInfo ("M", "Pump", "", true, pumpOptions));
      ...
      ventilatorMenuStructure.Items.Add ("M", new MqttMenuItemInfo ("M", "Fan", "", true, fanOptions));
      ...
      lightModeOptions.Add (2, "Timer");
      lightModeOptions.Add (3, "Above Threshold");
      lightModeOptions.Add (4, "Below Threshold");
      //lightModeOptions.Add (5, "PWM");
      //lightModeOptions.Add (6, "Supplement");
